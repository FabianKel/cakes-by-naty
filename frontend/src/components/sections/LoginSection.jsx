      ...
      <div className="flex items-center justify-center min-h-screen bg-[url('/fondos/fondo.webp')] bg-cover backdrop-blur-sm">
        <div className="z-10 bg-white/80 w-full max-w-sm md:max-w-lg mx-auto p-6 md:p-12 py-12 md:py-20 rounded-lg shadow-lg border border-baseLilac">
          <div className="text-center mb-8">
            <h1 className="text-2xl md:text-4xl font-semibold font-cursive text-titlesPurple1">¡Bienvenido!</h1>
          </div>
          {alertMessage && (
          ...
          <form onSubmit={formik.handleSubmit}>
            <div className="mb-2">
              <input
                ...
                className="w-full p-3 md:p-4 border border-borderPurple rounded-md font-poppins focus:outline-none focus:ring-2 focus:ring-borderPurple focus:border-borderPurple mb-6"
              />
            ...
            <div className="mb-8 mt-12">
              <Button
                type="submit"
                className="w-full p-3 md:p-4 bg-white text-black border-baseLilac border-2 rounded-md font-poppins hover:bg-buttonhoverPurple hover:text-white transition duration-300"
              >
                Iniciar Sesión
              </Button>
            </div>
          ...
          <div className="text-center mt-8">
            <p className="text-sm md:text-base">
              ...
              <a
                ...
                className="text-buttonhoverPurple hover:text-buttonhoverPurple1 hover:cursor-pointer font-bold transition-colors"
              >
                Regístrate
              </a>
            </p>
