    ...
    const agregarProducto = async () => {
        ...
        const producto = {
            ...
            detalles: {
                ...
                sabor_galleta_id: productData.detalles.sabor_galleta_id ? parseInt(productData.detalles.sabor_galleta_id) : null,
                    ...
                    <div className="p-8 bg-white border border-gray-300 rounded-md shadow-inner">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mt-8 flex justify-end">
                                <Button
                                    type="submit"
                                    className="p-4 bg-green-500 hover:scale-105 text-white rounded-md"
                                >
                                    Agregar Producto
                                </Button>
                            </div>
