            ...
            <nav>
                <ul className="flex space-x-8 items-center">
                    ...
                    <a href="https://www.instagram.com/cakes.bynaty/" target="_blank" rel="noopener noreferrer">
                        ...
                        <Link href="/catalog" className="text-lg text-gray-800  hover:text-hoverPink font-navheader mr-6 ">Catálogo</Link>
                    </li>
                    <li className="flex items-center">
                        <Link href="/about" className="text-lg text-gray-800 hover:text-hoverPink font-navheader mr-6">Sobre Nosotros</Link>
                        <Link href="/login" className="text-lg text-gray-800 hover:text-hoverPink font-navheader ml-6 mr-6 ">Iniciar Sesión</Link>
